...
public class PaymentDetailService extends ActionBarActivity implements TaskGetCurrentYear<String>
{
	...
	protected void onCreate(Bundle savedInstanceState) 
		{
			...
			//setContentView(R.layout.fragment_payment_main);
	...
	public void getCurrentYearRest(String paramYear) {
		...
		Bundle 					bundleFragmentDate		=	new Bundle();
		bundleFragmentDate.putString("paramYear", paramYear);
		Fragment				fragmentPaymentDate		=	new PaymentFragmentDate();
								fragmentPaymentDate.setArguments(bundleFragmentDate);
		
		FragmentManager			fragmentManager			= 	getFragmentManager();
		FragmentTransaction		fragmentTransaction		=	fragmentManager.beginTransaction();
		
		fragmentTransaction.add(R.id.payment_date_frame, fragmentPaymentDate);
		fragmentTransaction.add(R.id.payment_detail_frame, new PaymentFragmentDetail());
